...
=head2 YAML FILE (tscr_opts.yml) FORMAT
...
=item py-pwn : (python, python3)

	from pwn import *
	if __name__ == '__main__':

=item py-main : (python, python3) 
